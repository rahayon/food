    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designate whether this user should be treated as active. unselect thisinstead of deleting accounts', verbose_name='active')),
